...
class Service {
    ...
    createUser(obj, loginUserObject){
        ...
        return axios.post(`${Setting.dev4.url}bq/v1/user/create`,
    ...
    updateUser(obj, loginUserObject){
        ...
        return axios.put(`${Setting.dev4.url}bq/v1/user/update/${obj.userId}`,
    ...
    getCelebrityList(loginUserObject){
        return axios.get(`${Setting.dev4.url}bq/v1/celebs/fetch/`,
         {
              headers: {
                token: loginUserObject.loginUser.token.access_token,
                scope: 'Dashboard'
