...
class UserApiService {
    ...
    getUsersByFilterMap = (filterMap) => {
         // return axios.post(`${Setting.dev.url}user/fetch`, filterMap ,{ headers: { 'Access-Control-Allow-Origin': '*' } });
         return new Promise((resolve, reject) => resolve(
            {
                "data": {
                    "status": {
    ...
    addUser = (object) => {
        ...
        axios.post(`${Setting.dev.url}/user/create`,object,{ headers: { 'Access-Control-Allow-Origin': '*' } });
    }
